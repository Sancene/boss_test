...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [logo, point];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/kiosk.svg
  String get kiosk => 'assets/svg/kiosk.svg';

  /// File path: assets/svg/print.svg
  String get print => 'assets/svg/print.svg';

  /// File path: assets/svg/shipment.svg
  String get shipment => 'assets/svg/shipment.svg';

  /// File path: assets/svg/store.svg
  String get store => 'assets/svg/store.svg';

  /// List of all assets
  List<String> get values => [faq, kiosk, print, shipment, store];
}
